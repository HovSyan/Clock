...
{
    public partial class CircleProgressBarMinute : UserControl
    {
        int progress;

        public CircleProgressBarMinute()
        {
            progress = DateTime.Now.Minute;
            InitializeComponent();
        }

        private void CircleProgressBarMinute_Paint(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.DrawString(DateTime.Now.Minute.ToString(),
